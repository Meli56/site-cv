    ...
    class UserDAO{
        ...
        public function insert($user){
            if ($user instanceof User){
                $db = SqliteConnection::getInstance()->getConnection();
                $query = "insert into users(mail,nom,prenom,birth,gender,height,weight, password) values (:m,:n,:f,:b,:g,:h,:w,:p)";
                $stmt = $db->prepare($query);
        ...
        public function update($user, $oldMail){
            if($user instanceof User){
                ...
                $query = "update users set name = :n, fname = :f, birthDate = :b, gender = :g, height = :s, weight = :w, mail = :e, password = :p WHERE mail = :old";
